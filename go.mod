...
require (
	github.com/mike-ward/go-glyph v1.2.0
	github.com/mike-ward/go-glyph/backend/sdl2 v1.0.1 // sdl2 backend unchanged
	github.com/mike-ward/go-glyph/backend/web v0.0.0
