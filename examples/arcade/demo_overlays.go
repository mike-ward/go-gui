						...
						OnClick: func(_ *gui.Layout, e *gui.Event, w *gui.Window) {
							w.Dialog(gui.DialogCfg{
								...
								OnReply: func(reply string, w *gui.Window) {
									gui.State[ArcadeApp](w).DialogResult = "Reply: " + reply
								},
								OnCancelNo: func(w *gui.Window) {
									gui.State[ArcadeApp](w).DialogResult = "Cancelled"
								},
							})
							e.IsHandled = true
						},
					...
					gui.Button(gui.ButtonCfg{
						...
						OnClick: func(_ *gui.Layout, e *gui.Event, w *gui.Window) {
							w.Dialog(gui.DialogCfg{
								...
								OnOkYes: func(w *gui.Window) {
									gui.State[ArcadeApp](w).DialogResult = "Custom OK"
								},
							})
							e.IsHandled = true
						},
				...
				Content: []gui.View{
					gui.Button(gui.ButtonCfg{
						...
						OnClick: func(_ *gui.Layout, e *gui.Event, w *gui.Window) {
							...
							if np == nil {
								gui.State[ArcadeApp](w).DialogResult = "No native platform"
								e.IsHandled = true
								return
							}
